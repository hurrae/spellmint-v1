...
export const Search = () => {
  ...
  return (
    ...
    >
      <label
        className="relative bg-white flex items-center justify-center border ring-8 ring-gray-300/20 py-2 px-2 rounded-lg gap-2 focus-within:border-zinc-300"
        htmlFor="search-bar"
      >
        <input
          id="search-bar"
          ...
          className="px-2 pr-6 w-full lg:min-w-[400px] rounded-md flex-1 outline-none bg-white"
        />
        <button
          type="submit"
