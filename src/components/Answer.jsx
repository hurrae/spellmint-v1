...
export const Answer = ({ markdown, sources }) => {
  return (
    <Wrapper
      title={
        <>
          <BookOpen20Regular /> Answer
        </>
      }
      content={
        markdown ? (
          ...
          <div className="flex flex-col gap-2">
            <div className="animate-pulse rounded-md bg-muted max-w-sm h-4 bg-zinc-200"></div>
            <div className="animate-pulse rounded-md bg-muted max-w-lg h-4 bg-zinc-200"></div>
            <div className="animate-pulse rounded-md bg-muted max-w-2xl h-4 bg-zinc-200"></div>
            <div className="animate-pulse rounded-md bg-muted max-w-lg h-4 bg-zinc-200"></div>
            <div className="animate-pulse rounded-md bg-muted max-w-xl h-4 bg-zinc-200"></div>
          </div>
        )
      }
    ></Wrapper>
